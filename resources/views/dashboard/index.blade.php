...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="card">
            <div class="content">
                <h1>{{number_format(json_decode($dashboard->data)->itemCount,0)}} <sup>Items</sup></h1>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card">
            <div class="content">
                <a href="{{action('TaxonomyController@category')}}"><h1>{{number_format(json_decode($dashboard->data)->catCount,0)}} <sup>Categories</sup></h1></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card">
            <div class="content">
                <a href="{{action('BoardsController@index')}}"><h1>{{number_format(json_decode($dashboard->data)->boardCount,0)}} <sup>Boards</sup></h1></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card">
            <div class="content">
                <h1>{{number_format(json_decode($dashboard->data)->auth,0)}} <sup>Auth</sup></h1>
            </div>
        </div>
    </div>

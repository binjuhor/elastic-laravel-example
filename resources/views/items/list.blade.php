                    ...
                    <tbody>
                        @foreach ($items as $item)
                           ...
                           <tr id="tax-{{ $item->id }}" data-id="@if(isset($item->craw_id)){{$item->craw_id}}@endif">
                                ...
                                <td>
                                    @if(isset($item->getInfo()->latest()->first()->salesdate))
                                        {{$item->getInfo()->latest()->first()->salesdate}}
                                    @endif
                                </td>
                                <td>
                                    @if(isset($item->getInfo()->latest()->first()->sales))
                                        {{$item->getInfo()->latest()->first()->sales}}
                                    @endif
                                </td>
                                <td>

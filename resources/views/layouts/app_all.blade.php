                    ...
                    <ul class="nav navbar-nav navbar-right tooltip-area">
                            ...
                            <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right icon-right arrow">
                                            ...
                                            <li class="divider"></li>
                                            <li><a href="{{ url('/logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa fa-sign-out"></i> Signout </a></li>
                                    </ul>
    ...
    <nav id="menu" data-search="close">
            <ul>
                    <li><span><i class="icon  fa fa-laptop"></i> Dashboard</span>
                            <ul>
                                    <li><a href="{{url('/')}}"><i class="icon  fa fa-th"></i> Dashboard New </a></li>
                            </ul>
                    </li>

                    <li><span><i class="icon  fa fa-th-list"></i> {{trans('taxonomies.title_page')}}</span>
                        <ul>
                            <li><a href="{{action('TaxonomyController@index')}}">{{trans('taxonomies.list')}}</a></li>
                            <li><a href="{{action('TaxonomyController@create')}}">{{trans('taxonomies.create')}}</a></li>
                        </ul>
                    </li>
                    <li><span><i class="icon  fa fa-th-list"></i> {{trans('items.title_page')}}</span>
                        <ul>
